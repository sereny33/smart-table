...
export const initPagination = ({pages, fromRow, toRow, totalRows}, createPage) => {
    // @DONE: #2.3 — подготовить шаблон кнопки для страницы и очистить контейнер
    ...
    return (data, state, action) => {
        // @DONE: #2.1 — посчитать количество страниц, объявить переменные и константы
        ...
        // @DONE: #2.4 — получить список видимых страниц и вывести их
        ...
        // @DONE: #2.5 — обновить статус пагинации
        ...
        // @DONE: #2.2 — посчитать сколько строк нужно пропустить и получить срез данных
